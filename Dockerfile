...
RUN wget https://downloads.mariadb.com/Connectors/java/connector-java-2.7.0/mariadb-java-client-2.7.0.jar -P /app/java-se-8u41-ri/lib
...
#ENV CLASSPATH $JAVA_HOME/lib/mariadb-java-client-2.7.0.jar
